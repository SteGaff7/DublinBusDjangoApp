# This script is used to build the initial SGD model.
# It should be run before the accompanying script: SGDPartialFitModel.py 
...
def outer_wrapper(line):
 ...
 # List of all bus routes
	...
	# Partialy fit the data to the model, this allows more data to be fitted in future
	...
	# Serialise the model in a joblib file
	filename = 'SGD_joblib_files/SGD_original_model.sav'
	joblib.dump(model, filename)

	
# Run outer_wrapper for a single route to build the initial model
outer_wrapper('75')
